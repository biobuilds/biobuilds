...
env LD_LIBRARY_PATH="${PREFIX}/lib" DYLD_LIBRARY_PATH="${PREFIX}/lib" \
    ...
    --without-debug --without-profiling --without-symbols --with-strip \
    --without-hostspec --with-check \
    ...
    --without-pcre --without-boost --without-gmp --without-gmock \
    --without-gui --without-gbench --without-vdb \
    ...
    --without-dbapi  --without-bdb --without-sqlite3 \
    --without-mysql --without-sybase --without-ftds --without-mongodb \
    --without-hdf5 --without-cereal --without-avro \
    --without-krb5 --without-curl --without-local-lbsm --without-fastcgi \
